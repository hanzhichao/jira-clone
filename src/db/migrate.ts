...
const CREATE_SQLITE = {
  ...
  projects: `CREATE TABLE IF NOT EXISTS projects (id TEXT PRIMARY KEY, name TEXT NOT NULL, image_id TEXT, workspace_id TEXT NOT NULL, created_at TEXT DEFAULT (datetime('now')), updated_at TEXT DEFAULT (datetime('now')))`,
  tasks: `CREATE TABLE IF NOT EXISTS tasks (id TEXT PRIMARY KEY, name TEXT NOT NULL, status TEXT NOT NULL, workspace_id TEXT NOT NULL, project_id TEXT, assignee_id TEXT, description TEXT, due_date TEXT, position INTEGER NOT NULL, created_at TEXT DEFAULT (datetime('now')), updated_at TEXT DEFAULT (datetime('now')))`,
...
const CREATE_MYSQL = {
  ...
  projects: `CREATE TABLE IF NOT EXISTS projects (id VARCHAR(50) PRIMARY KEY, name VARCHAR(256) NOT NULL, image_id VARCHAR(50), workspace_id VARCHAR(50) NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP, updated_at DATETIME DEFAULT CURRENT_TIMESTAMP)`,
  tasks: `CREATE TABLE IF NOT EXISTS tasks (id VARCHAR(50) PRIMARY KEY, name VARCHAR(256) NOT NULL, status VARCHAR(20) NOT NULL, workspace_id VARCHAR(50) NOT NULL, project_id VARCHAR(50), assignee_id VARCHAR(50), description TEXT, due_date DATETIME, position INT NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP, updated_at DATETIME DEFAULT CURRENT_TIMESTAMP)`,
...
const CREATE_POSTGRES = {
  ...
  projects: `CREATE TABLE IF NOT EXISTS projects (id VARCHAR(50) PRIMARY KEY, name VARCHAR(256) NOT NULL, image_id VARCHAR(50), workspace_id VARCHAR(50) NOT NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP)`,
  tasks: `CREATE TABLE IF NOT EXISTS tasks (id VARCHAR(50) PRIMARY KEY, name VARCHAR(256) NOT NULL, status VARCHAR(20) NOT NULL, workspace_id VARCHAR(50) NOT NULL, project_id VARCHAR(50), assignee_id VARCHAR(50), description TEXT, due_date TIMESTAMP, position INTEGER NOT NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP)`,
